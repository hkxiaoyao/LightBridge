...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["LightBridge-admin", "jwt.<token>"].
	// - We always select "LightBridge-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"LightBridge-admin"},
}
